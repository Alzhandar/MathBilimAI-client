...
const Dashboard = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full items-center px-4 md:px-6 bg-white">
                ...
                <nav className="sm:ml-auto flex gap-4 sm:gap-6">
                    <Link href="#" prefetch={false} legacyBehavior>
                        <a className="text-xs text-gray-700 hover:underline underline-offset-4">Қызмет көрсету шарттары</a>
                    </Link>
                    <Link href="#" prefetch={false} legacyBehavior>
                        <a className="text-xs text-gray-700 hover:underline underline-offset-4">Құпиялылық</a>
                    </Link>
                    <Link href="#" prefetch={false} legacyBehavior>
                        <a className="text-xs text-gray-700 hover:underline underline-offset-4">Бізбен байланысыңыз</a>
                    </Link>
                </nav>
                <div className="flex gap-4 mt-4 sm:mt-0">
                    <Link href="https://www.facebook.com" prefetch={false} legacyBehavior>
                        <a className="text-gray-700 hover:text-blue-600" aria-label="Facebook">
                    ...
                    <Link href="https://www.twitter.com" prefetch={false} legacyBehavior>
                        <a className="text-gray-700 hover:text-blue-400" aria-label="Twitter">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                    ...
                    <Link href="https://www.instagram.com" prefetch={false} legacyBehavior>
                        <a className="text-gray-700 hover:text-pink-600" aria-label="Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
